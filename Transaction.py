...
class Transaction:
    ...
    def __init__(self, sender, receiver, amount, time=int(time.time()), signature=None):
        """
    ...
    def from_string(cls, string):
        ...
        return Transaction(bytes(fields[0], encoding='ascii'), bytes(fields[1], encoding='ascii'),
